...
<script type="text/javascript" src="http://gc.kis.scr.kaspersky-labs.com/1B74BD89-2A22-4B93-B451-1C9E1052A0EC/main.js" charset="UTF-8"></script></head>
 ...
 <script>
      var webroot = "<?php echo $this->Url->build('/'); ?>";
  </script>
  <script src="<?php echo $this->Url->build('/'); ?>bower_components/materialize/dist/js/materialize.js"></script>
  <script src="<?php echo $this->Url->build('/'); ?>bower_components/angular/angular.min.js"></script>
  <script src="<?php echo $this->Url->build('/'); ?>bower_components/angular-route/angular-route.min.js"></script>
  ...
  <nav class="light-blue lighten-1" role="navigation">
    <div class="nav-wrapper container"><a id="logo-container" href="<?php echo $this->Url->build('/'); ?>" class="brand-logo">Management</a>
      <ul class="right hide-on-med-and-down">
        <li><a href="<?php echo $this->Url->build('/'); ?>users/index">My Account</a></li>
...
<div class="container"> 
  ...
  <!--  Scripts-->
 <script src="<?php echo $this->Url->build('/'); ?>js/app.js"></script>
  <script src="<?php echo $this->Url->build('/'); ?>js/custom.route.js"></script>
